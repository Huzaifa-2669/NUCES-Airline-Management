...
public:
    ...
    void Lahore::setNorthData(Planes* p)
    {
        for (int i = 0; i < 5; i++) {
            Local[i].setEconomy();
            Local[i].setBusiness();
            ...
            for (int j = 0; j < 2; j++) {
                Local[i].getFlights()[j].setDepartLoc("North Lahore");
            }
            Local[i].setFlights();
        }
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (int j = 0; j < 1; j++) {
                International[i].getFlights()[j].setDepartLoc("North Lahore");
            }
            International[i].setFlights();
        }
    }

    void Lahore::setSouthData(Planes* p)
    {
        for (int i = 5; i < 10; i++) {
            Local[i].setEconomy();
            Local[i].setBusiness();
            ...
            Local[i].setNumberofFlights();
            for (int j = 0; j < 2; j++) {
                Local[i].getFlights()[j].setDepartLoc("South Lahore");
            }
            Local[i].setFlights();
        }
        ...
        for (int i = 5; i < 10; i++) {
            ...
            International[i].setNumberofFlights();
            for (int j = 0; j < 1; j++) {
                International[i].getFlights()[j].setDepartLoc("South Lahore");
            }
            International[i].setFlights();
        }
    }

    void Lahore::DisplayNorthData()
    {
        Flight* dummy;
        string temp = "";
        ...
        cout << endl;
        cout << "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
        cout << "North Lahore Airport:" << endl << endl;
    ...
    void Lahore::DisplaySouthData()
    {
        ...
        cout << endl;
        cout << "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
        cout << "South Lahore Airport:" << endl << endl;
    ...
    void Lahore::LahoreSpecialFlight()
    {
        Flight* dummy;
        Route* rou;
        string spaces;
    ...
    void Lahore::RegisteredSeats(Booking& book)
    {
