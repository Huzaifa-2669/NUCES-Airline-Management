...
public:
    ...
    void setNorthData(Planes* p) {
        for (int i = 0; i < 5; i++)
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                Local[i].getFlights()[j].setDepartLoc("North Islamabad");
            }
            Local[i].setFlights();
        }
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            for (int j = 0; j < 1; j++)
            {
                International[i].getFlights()[j].setDepartLoc("North Islamabad");
            }
    ...
    void setSouthData(Planes* p) {
        for (int i = 0; i < 5; i++)
        {
            ...
            for (int j = 0; j < 2; j++)
            {
                Local[i].getFlights()[j].setDepartLoc("South Islamabad");
            }
            Local[i].setFlights();
        }
        ...
        for (int i = 0; i < 5; i++)
        {
            ...
            for (int j = 0; j < 1; j++)
            {
                International[i].getFlights()[j].setDepartLoc("South Islamabad");
            }
            International[i].setFlights();
        }
    }

    void DisplayNorthData() {
        Flight* dummy;
        string temp = "";
        cout << endl;
        cout << "-----------------------------------------------------";
        cout << "North Islamabad Airport : " << endl << endl;
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (int j = 0; j < International[i].numberofJourneys(); j++) {
                cout << dummy[j].getDate() << "\t\t" << "Inter" << "(" << dummy[j].getIndirect() << ")" << "\t";
                ...
                cout << fixed << setprecision(2) << "Departs: " << dummy[j].getDeparttime() << "\t"
                    << "Arrives: " << dummy[j].getArrivaltime() << "\t\t";
                if (dummy[j].COVID() == true) {
                    cout << "Active, Flight Terminated";
                }
                else {
    ...
    void DisplaySouthData() {
        Flight* dummy;
        string temp = "";

        cout << endl;
        cout << "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
        cout << "South Islamabad Airport" << endl << endl;
    ...
    void RegisteredSeats(Booking& book) {
