...
#include <iomanip>
    ...
    void Peshawar::setNorthData(Planes* p)
    {
        for (int i = 0; i < 5; i++) {
            Local[i].setEconomy();
            Local[i].setBusiness();
            ...
            for (int j = 0; j < 2; j++) {
                Local[i].getFlights()[j].setDepartLoc("North Peshawar");
            }
            Local[i].setFlights();
        }
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (int j = 0; j < 1; j++) {
                International[i].getFlights()[j].setDepartLoc("North Peshawar");
            }
            International[i].setFlights();
        }
    }

    void Peshawar::setSouthData(Planes* p)
    {
        for (int i = 5; i < 10; i++) {
            Local[i].setEconomy();
            Local[i].setBusiness();
            ...
            Local[i].setNumberofFlights();
            for (int j = 0; j < 2; j++) {
                Local[i].getFlights()[j].setDepartLoc("South Peshawar");
            }
            Local[i].setFlights();
        }
        ...
        for (int i = 5; i < 10; i++) {
            ...
            International[i].setNumberofFlights();
            for (int j = 0; j < 1; j++) {
                International[i].getFlights()[j].setDepartLoc("South Peshawar");
            }
            International[i].setFlights();
        }
    }

    void Peshawar::DisplayNorthData()
    {
        Flight* dummy;
        string temp = "";
        ...
        cout << endl;
        cout << "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
        cout << "North Peshawar Airport" << endl << endl;
    ...
    void Peshawar::DisplaySouthData()
    {
        Flight* dummy;
        string temp = "";
        ...
        cout << endl;
        cout << "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
        cout << "South Peshawar Airport" << endl << endl;
    ...
    void Peshawar::PeshawarSpecialFlight()
    {
        Flight* dummy;
        Route* rou;
        string spaces;
    ...
    void Peshawar::ChangeDepartTimes() {
    ...
    void Peshawar::RegisteredSeats(Booking& book)
    {
