...
#include<iomanip>
    ...
    void setNorthData(Planes* p)
    {
        for (int i = 0; i < 5; i++) {
            ...
            for (int j = 0; j < 2; j++) {
                Local[i].getFlights()[j].setDepartLoc("North Karachi");
            }
            Local[i].setFlights();
        }
        ...
        for (int i = 0; i < 5; i++) {
            ...
            for (int j = 0; j < 1; j++) {
                International[i].getFlights()[j].setDepartLoc("North Karachi");
            }
    ...
    void setSouthData(Planes* p)
    {
        for (int i = 5; i < 10; i++) {
            ...
            Local[i].setNumberofFlights();
            for (int j = 0; j < 2; j++) {
                Local[i].getFlights()[j].setDepartLoc("South Karachi");
            }
            Local[i].setFlights();
        }
        ...
        for (int i = 5; i < 10; i++) {
            ...
            International[i].setNumberofFlights();
            for (int j = 0; j < 1; j++) {
                International[i].getFlights()[j].setDepartLoc("South Karachi");
            }
            International[i].setFlights();
        }
    }
    ...
    void DisplayNorthData()
    {
        ...
        cout << "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
        cout << "North Karachi Airport:" << endl << endl;
    ...
    void DisplaySouthData()
    {
        ...
        cout << "----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------" << endl;
        cout << "South Karachi Airport:" << endl << endl;
